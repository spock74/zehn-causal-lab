...
const InterventionControls = ({ 
  ...
  return (
    <>
      <div className="absolute top-4 right-4 w-72 bg-card text-card-foreground border border-border rounded-xl overflow-hidden flex flex-col transition-all duration-300 shadow-lg">
        {/* Header */}
