...
const ExamplesMenu = ({ onSelectGraph }: ExamplesMenuProps) => {
  ...
  return (
    <div className="relative z-40">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 border border-border rounded-xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-top-2 duration-200">
