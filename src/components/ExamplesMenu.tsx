...
const ExamplesMenu = ({ onSelectGraph }: ExamplesMenuProps) => {
  ...
  return (
    <div className="relative z-40">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-white dark:bg-slate-950 text-popover-foreground border border-border rounded-xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-top-2 duration-200">
