...
const ProbabilityPanel = ({ selectedNode, graph, onUpdate, onClose }: ProbabilityPanelProps) => {
  ...
  return (
    <div className="absolute bottom-4 right-4 w-96 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-50 border border-border rounded-xl overflow-hidden flex flex-col max-h-[50vh] transition-all duration-300 shadow-xl">
      {/* Header */}
